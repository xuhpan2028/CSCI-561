...
class AlphaBetaPlayer:
    def __init__(self, depth=3, proximity_weight=7.88633778206626, wall_weight=3.8126929504694527,
                 liberty_bonus=1.4909022427365748, eye_bonus=2.462792281435908, not_near_stone_penalty=-0.573216759778493):
...
if __name__ == "__main__":
    ...
    player = AlphaBetaPlayer(depth=3)
